                ...
                if idu in user:
                    if passu == "":
                        ...
                        if passu in user[idu]:
                            ...
                            go.grid(row =5 ,column =1,padx = 5, pady = 20)
                        else:
                            Inc = Label(self, text = "Invalid ID ", font = MEDIUM)
...
class Page3(Frame):
    ...
    def __init__(self,parent,controller):
        ...
        title = Label(self, text = "Here is your Schedule", font =SMALL)
        ...
        def event():
            ...
            show.grid(row = 2, column = 0, padx = 24, pady =10)

        
        showevent = Button(self, text = "Show", command = event)
